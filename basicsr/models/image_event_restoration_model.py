...
def hash_3d(ts, ys, xs):
    return xs + 512*ys + 512*512* ts
# a * 39 + b * 255 + c
# a * 100 + b * 10 + c
# 111 =  100 
# 11 
def dehash_3d(input_s):
    ts, temp = input_s // (512*512), input_s % (512*512)
    ys, xs = (temp) // 512, temp % 512
    return ts, ys, xs
...
class ImageEventRestorationModel(BaseModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        preds = self.net_g(self.lq, self.count_tensor, self.index_3d_tensor, self.bs, self.spatial_shapes)
